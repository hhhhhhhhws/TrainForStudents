...
class TaskCenterController: MyBaseUIViewController , AVCaptureMetadataOutputObjectsDelegate  {
    ...
    @IBOutlet weak var btn_s_type1: UIButton!
    
    @IBOutlet weak var btn_s_type2: UIButton!
    
    @IBOutlet weak var btn_s_type3: UIButton!
    
    @IBOutlet weak var btn_s_type4: UIButton!
    
    @IBOutlet weak var btn_s_type5: UIButton!
    
    @IBOutlet weak var btn_s_type6: UIButton!
    
    @IBOutlet weak var btn_s_type7: UIButton!
    
    @IBOutlet weak var btn_s_type8: UIButton!
    ...
    override func viewDidLoad() {
        ...
        btn_s_type1.layer.cornerRadius = 4
        btn_s_type2.layer.cornerRadius = 4
...
//        UIView.commitAnimations()
    ...
    @IBAction func btn_searchAction_inside(_ sender: UIButton) {
        ...
        var searchType = [Int]()
        if btn_s_type1.isSelected{
            searchType.append(1)
        }
        
        if btn_s_type2.isSelected{
            searchType.append(2)
        }
        
        if btn_s_type3.isSelected{
            searchType.append(3)
        }
        
        if btn_s_type4.isSelected{
            searchType.append(4)
        }
        
        if btn_s_type5.isSelected{
            searchType.append(5)
        }
        
        if btn_s_type6.isSelected{
            searchType.append(6)
        }
        
        if btn_s_type7.isSelected{
            searchType.append(7)
        }
        
        if btn_s_type8.isSelected{
            searchType.append(8)
        }
        searchParam?["type"] = searchType
        if isOverTab{
            overView.initLimitPage()
            getOverCollectionDatasource()
    ...
    @IBAction func btn_clear_inside(_ sender: UIButton) {
        ...
        searchTypeInit(btn: btn_s_type1)
        searchTypeInit(btn: btn_s_type2)
        searchTypeInit(btn: btn_s_type3)
        searchTypeInit(btn: btn_s_type4)
        searchTypeInit(btn: btn_s_type5)
        searchTypeInit(btn: btn_s_type6)
        searchTypeInit(btn: btn_s_type7)
        searchTypeInit(btn: btn_s_type8)
    ...
    func searchTypeInit(btn: UIButton){
        btn.backgroundColor = UIColor(hex: "EBEBF1")
